...
function theEnd () {
    ...
    if (solves + userCells < 81) { 
        ...
        myPart = myPart + "(Mathematically, solving a sudoku puzzle without making any guesses requires at least 17 values to start -- ";
        myPart = myPart + "but depending on where the starting values are located, 17 might not be enough.)"
    } else {
